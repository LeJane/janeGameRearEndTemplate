...
$("#Ul-menu-text").html(menu_text);
	...
	var columns = [
		...
		},
		{
			...
			render : function(data, type, row, meta) {
				...
				result += '<button onclick="showModal(\'edit\',\''+row.Id+'\')" data-target="#" data-toggle="modal"  type="button" class="editBtn editBtn-info"><i class="fa fa-pencil"></i>修改</button>&nbsp;';
	...
	//表格setting
	var setting = {
		listUrl :wear+"FuelCal/list_info",
		editUrl : web_url+"FuelTank/UpdateCarFueCallInfo",
		deleteUrl : web_url+"FuelTank/DelCarFuelCalInfo",
		deletemoreUrl : web_url+"FuelTank/DelCarFuelCalInfoList",
		columnDefs : columnDefs, //表格列定义
		columns : columns, //表格列
		dataTableDiv : 'fuelCal', //表格
	...
	var windowId = "commonWin";
			...
			var showModal=function(meth,id){
				...
				if(meth=='add'){
					var remote=wear+"FuelCal/Add";
				}else{
					var remote=wear+"FuelCal/Edit?update_code="+id;
