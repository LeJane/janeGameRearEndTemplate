...
// 显示隐藏列
var menu_text = "";
var table = $("#dataTable tr th:gt(2)");
...
var columns = [
    ...
    },
    {
        ...
        render : function(data, type, row, meta) {
            var editUrlPath =wear+"Group/Edit";//+"/edit/"+ row.Code+".html"; //修改地址
            var result = '';
            //修改按钮
...
//表格setting
var setting = {
    listUrl :wear+"Group/list_info",
    editUrl : web_url+"CarFleetGroup/UpdateFleetGroup",
    deleteUrl : web_url+"CarFleetGroup/DelFleetGroup",
    deletemoreUrl : web_url+"CarFleetGroup/DelFleetGroupList",
...
var showModal=function(meth,id){
    ...
    if(meth=='add'){
        var remote=wear+"Group/Add";
    }else{

        var remote=wear+"Group/Edit?update_code="+id;
