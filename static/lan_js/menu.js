...
function lanSubmit(id,url,modalId,treeobj){
	if(treeobj =="undefined" || !treeobj || !treeobj==null){
		treeobj="";
	}else{
		treeobj=treeobj;
	}
...
function lanSubmitMenu(id,param,url,modalId){
		if (!modalId || modalId =="undefined" || modalId==null){
			modalId="commonWin";
		}else{
			modalId=modalId;
...
function lanSubmitParam(param,url){
	...
	// $(" .fa ").on("click",function(){
			...
			// var aa=$(this).parent().parent().next().next().next();
