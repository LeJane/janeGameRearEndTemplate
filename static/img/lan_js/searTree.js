 ...
 * @param searchConditionId 文本框的id
 */
function search_ztreeDemo(treeId, searchConditionId,type) {
	
    searchByFlag_ztreeDemo(treeId, searchConditionId, "",type);
}
 ...
 * @param flag                  需要高亮显示的节点标识
 */
function searchByFlag_ztreeDemo(treeId, searchConditionId, flag,type) {
    //<1>.搜索条件
    var searchCondition = $('#' + searchConditionId).val();
    var highlightNodes = [];
    var allNodes = [];
