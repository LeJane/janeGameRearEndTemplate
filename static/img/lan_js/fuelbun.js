...
$("#Ul-menu-text").html(menu_text);
	...
	var columns = [
		...
		},
		{
			...
			render : function(data, type, row, meta) {
				var editUrlPath =wear+"FuelBun/Edit";//+"/edit/"+ row.Code+".html"; //修改地址
				var result = '';
	...
	//表格setting
	var setting = {
		listUrl :wear+"FuelBun/list_info",
		editUrl : web_url+"FuelBun/UpdateCarFueBunlInfo",
		deleteUrl : web_url+"FuelTank/DelCarFuelBunInfo",
		deletemoreUrl : web_url+"FuelTank/DelCarFuelBunInfoList",
		columnDefs : columnDefs, //表格列定义
		columns : columns, //表格列
		dataTableDiv : 'fuelBun', //表格
	...
	var windowId = "commonWin";
			...
			var showModal=function(meth,id){
				...
				if(meth=='add'){
					var remote=wear+"FuelBun/Add";
				}else{
					var remote=wear+"FuelBun/Edit?update_code="+id;
