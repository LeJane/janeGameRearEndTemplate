(function(window,$){
    ...
    realTimeMonitoring = {
        init: function(){
            ...
            //计算后地图高度
            newMapHeight = winHeight - headerHeight - tabContHeight + 34;
            $MapContainer.css({
            ...
            setTimeout(function () {
            	$.fn.zTree.init($("#treeDemoRealMapRealMap"), setting);
            }, 500);
        ...
        */
        ...
        onDbClickV: function(e, treeId, treeNode){
            ...
            if (nodes[0].checked == false) {
                ...
                realTimeMonitoring.searchByFlag("treeDemoRealMap", nodes[0].id, null, 2)
            }
        ...
        onCheckVehicle: function(e, treeId, treeNode){
            ...
            if(cheakdiyuealls.length<=400){
                ...
                if (treeNode.checked) {//订阅
                    cancelList=[];
                    webSocket.subscribe("/user/" + $("#userName").text() + "/location", realTimeMonitoring.updataRealTime,"/app/vehicle/location", requestStrS);
                    realTimeMonitoring.searchByFlag("treeDemoRealMap", treeNode.id, null, 2);
                    realTimeMonitoring.realTimeDatatAdapt();
                    //勾选订阅显示报警车辆信息
                    var zTreeSubscription = $.fn.zTree.getZTreeObj("treeDemoRealMap");
                    ...
                    realTimeMonitoring.searchByFlag("treeDemoRealMap", treeNode.id, null, 3);
        ...
        updataRealTime: function(msg){
            var data = $.parseJSON(msg.body)
             if(data.desc!=="neverOnline"){
                 ...
                 var brand = realTimeMonitoring.searchNeverOnline("treeDemoRealMap", data.vid)[0].name;
        ...
        updataRealTree: function(msg){
            ...
            if (data.desc.msgID == 39321) {
                ...
                if(upPosition[0].vehicleStatus == 4 ) {
                    ...
                    realTimeMonitoring.searchByFlag("treeDemoRealMap", upPosition[0].vehicleId, null, 4);
        ...
        hidNeverOnline: function(){
            for (var i = 0; i < neverOline.length; i++) {
                realTimeMonitoring.hideNo("treeDemoRealMap", neverOline[i])
            }
        },
        showNeverOnline: function(){
            for (var i = 0; i < neverOline.length; i++) {
                realTimeMonitoring.showNo("treeDemoRealMap", neverOline[i])
            }
        },
        //筛选车辆
        chooseMiss: function(){
        ...
        search_condition: function(){
            search_ztree('treeDemoRealMap','search_condition','vehicle');
        },
        //实时监控数据加载
        ...
        dataTableDbclick: function(){
            ...
            $realTimeStateTableList.children("tbody").children("tr").unbind("click").bind("click",function(){
            	...
            	$(".ztree li a").removeClass("curSelectedNode");
  	          	var zTreeDataTables = $.fn.zTree.getZTreeObj("treeDemoRealMap");
