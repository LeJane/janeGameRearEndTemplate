    ...
    return {
        ...
        init: function () {
            ...
            var treeDataSource2 = new DataSourceTree({
                data: [
                    // { name: '兰子奇 <div class="tree-actions"></div>', type: 'folder', additionalParameters: { id: 'F11' } },
                    // { name: 'Jane <div class="tree-actions"></div>', type: 'folder', additionalParameters: { id: 'F12' } },
                    // { name: '<i class="fa fa-bell gold"></i>小兰', type: 'item', additionalParameters: { id: 'I11' } },
                    // { name: '<i class="fa fa-bar-chart-o darkorange"></i> 哈哈哈', type: 'item', additionalParameters: { id: 'I12' } }
                ],
                delay: 400
            });
