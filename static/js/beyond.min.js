function getThemeColorFromCss(n){
	var t=$("<span><\/span>").hide().appendTo("body"),i;return t.addClass(n),i=t.css("color"),t.remove(),i
...
function InitiateSideMenu(){
	...
	$("#sidebar-collapse").on("click",function(){
		...
		var patt1=new RegExp("/RealtimePosition/index");
		if(patt1.test(url) && !$("#RealVideo").is(':hidden')){
	...
	$(".sidebar-menu").on("click",function(t){
		...
		if(i&&i.length!=0){
			...
			if(r=i.next().get(0),!$(r).is(":visible")){
				...
				//console.log($(r));
				f=$(r.parentNode).closest("ul");
					if(n&&f.hasClass("sidebar-menu"))
						return;
					//console.log(f.find("> .open > .submenu"));
